...
class DesignResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            'id' => $this->id,
            'main_category' => $this->sanitizeText($this->main_category),
            'description' => $this->sanitizeText($this->description),
            'sub_categories' => $this->normalizeSubCategories($this->sub_categories),
    ...
    private function normalizeSubCategories(mixed $subCategories): array
    {
